...
public class NoteDAO {
    ...
    public boolean update(Note note){
        ...
        values.put(NotesTable.COLUMN_SUBJECT, note.getSubject());
        values.put(NotesTable.COLUMN_TEXT, note.getText());
        return db.update(NotesTable.TABLENAME, values, NotesTable.COLUMN_ID + "=?", new String[]{String.valueOf(note.get_id())}) > 0;
    }

    public boolean delete(Note note){
       return db.delete(NotesTable.TABLENAME, NotesTable.COLUMN_ID + "=?", new String[]{String.valueOf(note.get_id())}) > 0;
    }
    ...
    public Note get(long id){
        ...
        Cursor cursor = db.query(true, NotesTable.TABLENAME, new String[]{NotesTable.COLUMN_ID,
                ...
                NotesTable.COLUMN_ID + "=?", new String[]{String.valueOf(id)}, null, null, null, null);
