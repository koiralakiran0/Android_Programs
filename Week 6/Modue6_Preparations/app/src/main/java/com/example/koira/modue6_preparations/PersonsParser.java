...
public class PersonsParser {
    public static class PersonsSAXParser extends DefaultHandler{
        ...
        public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
            ...
            if (localName.equals("person")){
                person = new Person();
                person.id = Long.valueOf(attributes.getValue("id")); //Try Catch
    ...
    public static class PersonPullParser{
        ...
        static public ArrayList<Person> parsePersons(InputStream inputStream) throws IOException, XmlPullParserException {
